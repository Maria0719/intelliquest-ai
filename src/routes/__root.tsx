...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "QuizAI — Generador inteligente de quizzes" },
      { name: "description", content: "Crea quizzes personalizados con IA, mide tu progreso y mantén tu racha de aprendizaje." },
      { name: "theme-color", content: "#1a1530" },
      { property: "og:title", content: "QuizAI — Generador inteligente de quizzes" },
      { name: "twitter:title", content: "QuizAI — Generador inteligente de quizzes" },
      { property: "og:description", content: "Crea quizzes personalizados con IA, mide tu progreso y mantén tu racha de aprendizaje." },
      { name: "twitter:description", content: "Crea quizzes personalizados con IA, mide tu progreso y mantén tu racha de aprendizaje." },
